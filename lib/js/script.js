...
$(function(){
    ...
    $.getJSON("https://api.moneypot.com/v1/list-bets?app_id="+config.app_id+"&access_token="+config.access_token, function(json){
        ...
        for(var i=data.length-1; i>=0; i--){
            ...
            var multiplier = 0;
            if(real_outcome == 0) multiplier = 60000000;
            if(real_outcome == 1) multiplier = 50000000;
            if(real_outcome == 2) multiplier = 40000000;
            if(real_outcome == 3) multiplier = 30000000;
            if(real_outcome == 4) multiplier = 20000000;
            if(real_outcome == 5) multiplier = 10000000;
            if(real_outcome == 6) multiplier = 80000000;
            if(real_outcome == 7) multiplier = 100000000;
            if(real_outcome == 8) multiplier = 80000000;
            if(real_outcome == 9) multiplier = 10000000;
            if(real_outcome == 10) multiplier = 20000000;
            if(real_outcome == 11) multiplier = 30000000;
            if(real_outcome == 12) multiplier = 40000000;
            if(real_outcome == 13) multiplier = 50000000;
            if(real_outcome == 14) multiplier = 60000000;
...
function createCoin(payload){
    ...
    var multiplier = 0;
    if(real_outcome == 0) multiplier = 60000000;
    if(real_outcome == 1) multiplier = 500000000;
    if(real_outcome == 2) multiplier = 40000000;
    if(real_outcome == 3) multiplier = 30000000;
    if(real_outcome == 4) multiplier = 20000000;
    if(real_outcome == 5) multiplier = 10000000;
    if(real_outcome == 6) multiplier = 80000000;
    if(real_outcome == 7) multiplier = 10000000;
    if(real_outcome == 8) multiplier = 80000000;
    if(real_outcome == 9) multiplier = 10000000;
    if(real_outcome == 10) multiplier = 20000000;
    if(real_outcome == 11) multiplier = 30000000;
